...
from text.data.preprocessing import LabelEncoder, MorphologyAnalyzer
...
class Vocab():
    def __init__(self, document:list=None, document_path:str=None, data:pd.DataFrame=None, text_col:str=None, morpheme_template=None, token_store_path=None, label_encoder=None, sentence_pieces=[1]):
        super().__init__()

        self.morpheme_encoder = MorphologyAnalyzer(morpheme_template)
        ...
        self.document = Document(document_text=document, document_path=document_path, morph_path=morpheme_template, sentence_pieces=sentence_pieces)
