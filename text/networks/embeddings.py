...
class WordEmbeddings(Embeddings):
    def __init__(self, vocab, data=None, batch_size=256, embed_path=None, weight_path=None):
        super(WordEmbeddings, self).__init__(vocab=vocab, return_array=False, frozen=False, embed_path=embed_path, weight_path=weight_path)
    ...
    def embed(self, weight_store_path=None, emb_store_path=None):
        ...
        """
        assert self.data is not None, "dataset object required to prepare embeddings"
